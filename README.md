...
- [x] Регистрация пользователя + 7-дневный триал
- [x] Ввод дохода/расхода (в Mini App и командами `/доход`, `/расход` в самом боте)
- [x] Расчёт: сколько можно откладывать на цель, не уходя в минус
- [x] Хранение и прогресс цели ("хотелки")
- [x] Регулярные напоминания (аренда и т.п.) — ежедневная проверка в 9:00
- [x] Месячный отчёт простыми словами

## Что логично добавить следующим шагом

- Категории расходов (аренда/товар/зарплата) для более точной аналитики
- Голосовой ввод суммы (Whisper API + разбор числа из текста)
- Реальная интеграция Payme/Click вместо заглушки
- Реферальная программа (+1 неделя за приглашённого друга)
- Push-уведомление с еженедельной сводкой по пятницам
